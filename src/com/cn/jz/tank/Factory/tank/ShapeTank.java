...
public class ShapeTank extends BaseTank {
    //坦克位子方向
    int x=200;
    int y=200;
    //方向枚举
    ...
    public ShapeTank(int x, int y, Dir dir, TankFrame tankFrame, Group group){
        this.x= x;
        this.y=y;
        this.dir=dir;
    ...
    public void paint(Graphics g){
        ...
        switch (dir){
            case LEFT:
                g.drawImage(this.group==Group.BAD?ResourceMgr.tankR:ResourceMgr.tankL,x,y,null);
                break;
            case RIGHT:
                g.drawImage(this.group==Group.BAD?ResourceMgr.tankR:ResourceMgr.tankR,x,y,null);
                break;
            case UP:
                g.drawImage(this.group==Group.BAD?ResourceMgr.tankU:ResourceMgr.tankU,x,y,null);
                break;
            case DOWN:
                g.drawImage(this.group==Group.BAD?ResourceMgr.tankD:ResourceMgr.tankD,x,y,null);
                break;
            default:
        }
